  ...
  return (
    ...
    >
      ...
      <div className="mt-1.5 flex flex-wrap items-center gap-1.5">
        {isLive && (
          <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-sm text-[10px] font-semibold bg-green-100 dark:bg-green-900/40 text-green-700 dark:text-green-300 uppercase tracking-wide">
        ...
        {isLocalized && event.lieu_nom && event.lieu_nom !== "national" && (
          <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-sm bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs">
        ...
        {!isLocalized && event.lieu_nom && event.lieu_nom !== "national" && (
          <span className="inline-flex items-center px-1.5 py-0.5 rounded-sm bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-xs">
            {event.lieu_nom}
          </span>
        )}
        ...
        <div className="flex items-center gap-1.5 min-w-0">
          ...
          {duplicateCount > 0 && (
            <button
              ...
              className="inline-block px-1.5 py-0.5 rounded-sm bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors shrink-0"
            >
          ...
          {duplicates.map((dup) => (
            <li key={dup.id} className="flex items-center gap-1.5 text-xs text-gray-500 dark:text-gray-400">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="shrink-0 text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
...
export default function EventFeed({
  ...
  return (
    ...
    <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
      ...
      {/* Header + tabs */}
      <div className="px-4 pt-2 pb-1.5 md:pt-2.5 md:pb-2 border-b border-gray-200 dark:border-gray-700 shrink-0">
          ...
          <div className="flex items-center gap-1.5">
            {activeTag && (
              <button
                ...
                className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-sm bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300 text-xs font-medium hover:bg-blue-200 transition-colors"
              >
                #{activeTag}
            ...
            <select
              ...
              className="text-[10px] px-1 py-0.5 rounded-sm border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/40 text-gray-600 dark:text-gray-300 focus:outline-hidden focus:border-blue-400 cursor-pointer"
        ...
        <div className="relative mb-1.5 md:mb-2">
          ...
          <input
            ...
            className="w-full pl-6 pr-3 py-1 text-xs rounded-sm border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/40 focus:outline-hidden focus:border-blue-400 focus:bg-white dark:focus:bg-gray-800 transition-colors"
          />
        </div>
          ...
          <div className="flex flex-col gap-3 p-4">
            {[...Array(5)].map((_, i) => (
              <div key={i} className="animate-pulse">
                <div className="h-3 bg-gray-200 dark:bg-gray-600 rounded-sm w-full mb-1.5" />
                <div className="h-3 bg-gray-200 dark:bg-gray-600 rounded-sm w-3/4 mb-2" />
                <div className="h-2 bg-gray-100 dark:bg-gray-700 rounded-sm w-1/2" />
              </div>
            ))}
          </div>
        )}
        ...
        {collapsed.length > 8 && !hasMoreLocal && !hasMore && (
          <div className="sticky bottom-2 flex justify-center pb-2 pointer-events-none">
            <button
              ...
              className="pointer-events-auto bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-xs rounded-full px-3 py-1 text-xs text-gray-500 dark:text-gray-400 hover:text-blue-600 hover:border-blue-300 transition-colors"
            >
              ↑ Haut
            </button>
          </div>
